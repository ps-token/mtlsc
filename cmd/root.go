...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.mtlsc.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".mtlsc" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".mtlsc")
	}
